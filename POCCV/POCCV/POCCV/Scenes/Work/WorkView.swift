...
//  POCCVClip
//
//  Created by Omar Hernandez Gonzalez on 08/03/24.
//
...
class WorkView: UIView {
    ...
    var didTap: ((Int) -> Void)?
    var data: EmploymentHistoryEntity?
    ...
    private func loadView() {
        contentView = loadViewFromNib(nibName: "WorkView", bundle: .main)
    ...
    func setText(data: EmploymentHistoryEntity) {
        self.data = data
